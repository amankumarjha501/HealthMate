function sendMessage() {
    ...
    var now = new Date();
    var date = now.toLocaleDateString(); // Format date (e.g., 'MM/DD/YYYY')
    var time = now.toLocaleTimeString(); // Format time (e.g., 'HH:MM:SS AM/PM')

    // Combine date and time
    var dateTime = date + ' ' + time;
    // Create a span for the timestamp
    var timestampSpan = document.createElement('span');
    timestampSpan.className = 'timestamp'; // Add a class for styling
    timestampSpan.style.fontSize = 'smaller';
    timestampSpan.style.color = 'grey';
    timestampSpan.innerHTML = dateTime;
    ...
    .then(data => {
        ...
        appendMessage('HealthMate', data.response);
...
function appendMessage(sender, message) {
    ...
    // Append timestamp and message to the message div
    chatHistory.appendChild(timestampSpan);
    chatHistory.appendChild(document.createElement('br')); // Line break for separation
...
function addMessageToChatBox(message, className) {
    ...
    chatHistory.appendChild(timestampSpan);
    chatHistory.appendChild(document.createElement('br')); // Line break for separation
    chatHistory.appendChild(messageParagraph);
